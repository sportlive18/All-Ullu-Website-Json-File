#!/usr/bin/env python3
"""
Mastiwala Video Scraper (Fresh Mode)
...
# CONFIG
# ==========================
BASE_URL = "https://mastiwala.com/"
import os
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
JSON_FILE = os.path.join(BASE_DIR, "mastiwala.json")
...
# ==========================
def main():
    print(f"Starting Mastiwala Scraper (Fresh Mode)")
    print("=" * 40)
