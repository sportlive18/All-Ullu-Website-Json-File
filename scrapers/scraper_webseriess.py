#!/usr/bin/env python3
"""
Webseriess Video Scraper (Fresh Mode)
...
# CONFIG
# ==========================
BASE_URL = "https://webseriess.net/"
import os
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
JSON_FILE = os.path.join(BASE_DIR, "webseriess.json")
...
# ==========================
def main():
    print(f"Starting Webseriess Scraper (Fresh Mode)")
    print("=" * 40)
