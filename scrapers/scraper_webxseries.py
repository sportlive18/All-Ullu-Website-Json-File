#!/usr/bin/env python3
"""
Webxseries Video Scraper (Fresh Mode)
...
# CONFIG
# ==========================
BASE_URL = "https://webxseries.tv/"
import os
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
JSON_FILE = os.path.join(BASE_DIR, "webxseries.json")
...
# ==========================
def main():
    print(f"Starting Webxseries Scraper (Fresh Mode)")
    print("=" * 40)
